            ...
            <Row gutter={16} style={{ display: "flex", alignItems: "center", height: "4rem" }}>
                <Col span={20}>
                    <div className={styles.imgAndName}>
                        ...
                        <div>
                            <p className={styles.title} style={{ paddingBottom: "0", marginBottom: "0", marginTop: "0.5rem" }}>{request.name.first + " " + request.name.last}</p>
                            01/01/2022
                        </div>
                    </div>
                ...
                {type == "incoming" && <>
                    <Col span={2} style={{ cursor: "pointer" }} onClick={(e) => modifyRequest(e, "accept", request)}>
                        <CheckOutlined className={styles.icon} />
                    </Col>
                    <Col span={2} style={{ cursor: "pointer" }} onClick={(e) => modifyRequest(e, "delete", request)}>
